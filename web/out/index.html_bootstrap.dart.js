    ...
    switch (state0) {
      ...
      case 2:
        ...
        if (t2 == null)
          ...
          actualParameters = $.toString(t1.sb_0);
          t1.sb_0 = $.JsStringBuffer$("");
          for (t3 = $.getInterceptor$JSArrayJSString(t2), i = 0; $.CONSTANT3.$lt(i, t3.get$length(t2)); ++i) {
            if (i > 0)
              $.add(t1.sb_0, ", ");
...
$$.MappedListIterator = {"": "Object;_list,_f,_endIndex,_liblib0$_length,_index,_liblib0$_current",
  _f$1: function(arg0) {
    return this._f.call$1(arg0);
  },
  get$current: function() {
  ...
  moveNext$0$bailout: function(state0, t1, t3, t2, t5) {
    switch (state0) {
      ...
      case 3:
        ...
        this._liblib0$_current = this._f$1(t3.$index(t1, this._index));
        t2 = this._index;
      case 4:
        state0 = 0;
...
$$.ListBase = {"": "Collection;",
  ...
  forEach$1: function(f) {
    var i;
    for (i = 0; $.CONSTANT3.$lt(i, this.get$length()); ++i)
  ...
  get$reversed: function() {
    return $.ReversedListView$(this, 0, null);
  },
  $isList: function() {
    return true;
  },
...
$$.SubListView = {"": "UnmodifiableListBase;",
  ...
  get$length: function() {
    ...
    if (typeof t1 !== "number")
      return this.get$length$bailout2(1, t1);
    if (typeof t3 !== "number")
      return this.get$length$bailout2(2, t1, t3);
    result = t1 - t3;
    if (result >= 0)
      return result;
    return 0;
  },
  get$length$bailout2: function(state0, t1, t3) {
    switch (state0) {
      case 0:
        t1 = this._absoluteIndex$1(this._end);
      case 1:
...
$$.ListView = {"": "SubListView;_list,_start,_end",
  $index: function(index) {
    ...
    if (typeof start !== "number")
      return this.$$index$bailout(2, index, start);
    end = this._absoluteIndex$1(this._end);
    if (typeof end !== "number")
      return this.$$index$bailout(3, index, start, end);
    $length = end - start;
    ...
    t3 = start + index;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout(4, index, start, 0, t1);
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
    if (t3 < 0 || t3 >= t1.length)
      throw $.ioore(t3);
  ...
  $$index$bailout: function(state0, index, start, end, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
  ...
  get$reversed: function() {
    return $.ReversedListView$(this._list, this._start, this._end);
  }
};
...
$$.ReversedListView = {"": "SubListView;_list,_start,_end",
  $index: function(index) {
    ...
    t3 = end - index - 1;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout(4, index, 0, end, t1, $.CONSTANT4);
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
    if (t3 < 0 || t3 >= t1.length)
      throw $.ioore(t3);
  ...
  $$index$bailout: function(state0, index, start, end, t1, t3) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
  ...
  get$reversed: function() {
    return $.ListView$(this._list, this._start, this._end);
  }
};

$$.ReverseListIterator = {"": "Object;_list,_start,_originalLength,_index,_liblib0$_current",
  moveNext$0: function() {
    var t1, t3, t2, t5;
    t1 = this._list;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
    ...
    if (typeof t2 !== "number")
      return this.moveNext$0$bailout(2, t1, t3, t2);
    if (typeof t5 !== "number")
      return this.moveNext$0$bailout(3, t1, t3, t2, t5);
    if (t2 <= t5)
      return false;
    this._index = t2 - 1;
    t3 = this._index;
  ...
  moveNext$0$bailout: function(state0, t1, t3, t2, t5) {
    switch (state0) {
      ...
      case 4:
        state0 = 0;
        this._index = $.$$sub(t2, 1);
        this._liblib0$_current = t3.$index(t1, this._index);
        return true;
    }
  },
  get$current: function() {
  ...
  _deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      ...
      case 3:
        var id, i;
        state0 = 0;
        for (t1 = $.getInterceptor$JSArrayJSString(values), i = 0; $.CONSTANT3.$lt(i, len); ++i)
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_unsubscribeOnError,_liblib5$_subscription,_liblib5$_onData,_onError,_onDone",
  cancel$0: function() {
  ...
  _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, _unsubscribeOnError) {
    ...
    this._liblib5$_subscription = t1.listen$3$onDone$onError(t2, this.get$_handleDone(), t3);
  }
};
...
$$.WebComponent = {"": "Object;",
  ...
  get$document: function() {
    return this._element.get$document();
  },
  set$text: function(v) {
...
$$._ListWatcher = {"": "_Watcher;debugName,_getter,_callback,_lastValue",
  _compare$1: function(currentValue) {
    ...
    if ($.$$eq($.length(this._lastValue), currentValue.length) !== true)
      return true;
    for (i = 0; $.CONSTANT3.$lt(i, $.length(this._lastValue)); ++i) {
...
$$.LinkedListNode = {"": "Object;_liblib4$_previous<,_liblib4$_next<,_liblib4$_list>,_value",
  _liblib4$_link$2: function(p, n) {
    var t1 = this._liblib4$_list;
    if (!(t1 == null))
      t1.set$_liblib4$_length($.$$add(t1.get$_liblib4$_length(), 1));
    this._liblib4$_next = n;
    this._liblib4$_previous = p;
    p.set$_liblib4$_next(this);
    n.set$_liblib4$_previous(this);
  },
  prepend$1: function(e) {
    var t1 = $.LinkedListNode$_(e, this._liblib4$_list);
    t1._liblib4$_link$2(this._liblib4$_previous, this);
    return t1;
  },
  remove$0: function() {
    var t1 = this._liblib4$_list;
    if (!(t1 == null))
      t1.set$_liblib4$_length($.$$sub(t1.get$_liblib4$_length(), 1));
    t1 = this._liblib4$_previous;
    if (!(t1 == null))
      t1.set$_liblib4$_next(this._liblib4$_next);
    t1 = this._liblib4$_next;
    if (!(t1 == null))
      t1.set$_liblib4$_previous(this._liblib4$_previous);
    this._liblib4$_next = null;
    this._liblib4$_previous = null;
...
$$.LinkedListSentinel = {"": "LinkedListNode;_liblib4$_previous,_liblib4$_next,_liblib4$_list,_value",
  remove$0: function() {
  ...
  LinkedListSentinel$0: function() {
    this._liblib4$_link$2(this, this);
  }
};

$$.LinkedList = {"": "Iterable;_liblib4$_sentinel,_liblib4$_length=",
  get$length: function() {
    return this._liblib4$_length;
  },
  add$1: function(e) {
    return this._liblib4$_sentinel.prepend$1(e);
  },
  get$add: function() {
  ...
  LinkedList$0: function() {
    this._liblib4$_sentinel._liblib4$_list = this;
  }
};

$$.LinkedListIterator = {"": "Object;_copy,_liblib4$_list>,_pos",
  get$current: function() {
    var t1, t2, t3;
    t1 = this._pos;
    if (typeof t1 !== "number")
  ...
  get$current$bailout: function(state0, t1) {
    switch (state0) {
      ...
      case 2:
        var t3, t2;
        if (state0 === 2 || state0 === 0 && $.$$ge(t1, 0) === true)
          switch (state0) {
            case 0:
              t1 = this._pos;
            case 2:
              state0 = 0;
              t3 = $.$$lt(t1, this._copy.length) === true;
              t1 = t3;
          }
        else
          t1 = false;
  ...
  moveNext$0: function() {
    ...
    t1 = this._pos;
    t3 = this._copy.length;
    if (typeof t1 !== "number")
      return this.moveNext$0$bailout(3, t1);
    return t1 < t3;
  },
  moveNext$0$bailout: function(state0, t1) {
    switch (state0) {
        ...
        L0:
          while (true)
            switch (state0) {
              ...
              case 2:
                state0 = 0;
                if ($.$$lt(t1, this._copy.length) === true) {
                  t1 = this._copy;
                  t2 = this._pos;
                  if (t2 !== (t2 | 0))
                    throw $.iae(t2);
                  if (t2 < 0 || t2 >= t1.length)
                    throw $.ioore(t2);
                  t3 = $.$$eq(t1[t2].get$_liblib4$_list(), this._liblib4$_list) !== true;
                  t1 = t3;
                } else
                  t1 = false;
                if (!t1)
      ...
      case 3:
        var t2, t3;
        state0 = 0;
        return $.$$lt(t1, this._copy.length);
    }
  },
  LinkedListIterator$1: function(_list) {
    var node, i, t1, i0;
    this._copy = $.List_List$fixedLength(this._liblib4$_list.get$length(), null);
    node = this._liblib4$_list._liblib4$_sentinel.get$next();
...
$$.Template = {"": "TemplateItem;node,children>,nodes>",
  ...
  conditional$3: function(template, exp, bodySetup) {
    $.add(this.children, $.ConditionalTemplate$(template, exp, bodySetup));
  },
...
$$.Game = {"": "WebComponent;_liblib$_root,__e2,__xBoardControls,__xGame,__e5,_liblib$__t,gameCount>,turnCount=,gameStartTime>,_element,_shadowRoots",
  created_autogenerated$0: function() {
    var __binding3, __binding4;
    this._liblib$_root = this.createShadowRoot$0();
    this._liblib$__t = $.Template$(this._liblib$_root);
    this._liblib$_root.set$innerHtml("    <div id=\"x-game\">\n    <div id=\"x-board-controls\">\n    <button class=\"btn btn-danger\" id=\"__e-2\">New game</button>\n    <p id=\"__e-5\"></p></div>\n    <content></content>\n    </div>\n    ");
    this.__xGame = this._liblib$_root.query$1("#x-game");
    this.__xBoardControls = this.__xGame.query$1("#x-board-controls");
    this.__e2 = this.__xBoardControls.query$1("#__e-2");
    this._liblib$__t.listen$2(this.__e2.get$onClick(), new $.Game_created_autogenerated_anon(this));
    this.__e5 = this.__xBoardControls.query$1("#__e-5");
    __binding3 = this._liblib$__t.contentBind$1(new $.Game_created_autogenerated_anon0(this));
    __binding4 = this._liblib$__t.contentBind$1(new $.Game_created_autogenerated_anon1(this));
    $.addAll(this.__e5.get$nodes(), [document.createTextNode("game "), __binding3, document.createTextNode(" started at "), __binding4, document.createTextNode(".\n        ")]);
  ...
  newgame$1: function(e) {
    var xBoard;
    this.gameStartTime = $.DateTime$_now();
    this.gameCount = this.gameCount + 1;
    xBoard = this.get$document().query$1("x-board").get$xtag();
    xBoard.set$turnCount(0);
    xBoard.set$turnStartTime(this.gameStartTime);
    xBoard.set$begun(false);
  }
};

$$.Board = {"": "WebComponent;_root,__e14,__e7,__t,begun=,turnCount=,turnStartTime<,turnEndTime,lastTurnDuration>,_element,_shadowRoots",
  created_autogenerated$0: function() {
    this._root = this.createShadowRoot$0();
    this.__t = $.Template$(this._root);
    this._root.set$innerHtml("    <template id=\"__e-7\" style=\"display:none\"></template>\n    <template id=\"__e-14\" style=\"display:none\"></template>\n    ");
    this.__e7 = this._root.query$1("#__e-7");
    this.__t.conditional$3(this.__e7, new $.Board_created_autogenerated_anon(this), new $.Board_created_autogenerated_anon0(this));
    this.__e14 = this._root.query$1("#__e-14");
    this.__t.conditional$3(this.__e14, new $.Board_created_autogenerated_anon1(this), new $.Board_created_autogenerated_anon2(this));
    this.__t.create$0();
  },
  inserted_autogenerated$0: function() {
    this.__t.insert$0();
  ...
  nextturn$2$reset: function(e, reset) {
    this.turnEndTime = $.DateTime$_now();
    this.lastTurnDuration = this.turnEndTime.difference$1(this.turnStartTime);
    this.turnStartTime = this.turnEndTime;
    this.turnCount = $.$$add(this.turnCount, 1);
    if (reset === true)
      this.turnCount = 0;
    if ($.$$gt(this.turnCount, 0) === true)
      this.begun = true;
  },
  nextturn$1: function(e) {
    return this.nextturn$2$reset(e, false);
  }
};
...
$$.Board_created_autogenerated_anon = {"": "Closure;this_0",
  call$0: function() {
    return this.this_0.get$begun() !== true;
  },
  $isFunction: true
};

$$.Board_created_autogenerated_anon0 = {"": "Closure;this_1",
  call$1: function(__t) {
    var __xBoard = $._ElementFactoryProvider_createElement_html("<div id=\"x-board\" class=\"span6\">\n          <h3>New board</h3>\n          <button class=\"btn btn-primary pull-right\" id=\"__e-6\">Begin game</button>\n          <p>this new game has not yet started.</p>\n          <content></content>\n        </div>");
    __t.listen$2(__xBoard.query$1("#__e-6").get$onClick(), new $.Board_created_autogenerated__anon3(this.this_1));
    $.addAll(__t, [document.createTextNode("\n        "), __xBoard, document.createTextNode("\n      ")]);
  },
  $isFunction: true
};

$$.Board_created_autogenerated__anon3 = {"": "Closure;this_2",
  call$1: function($$event) {
    this.this_2.nextturn$1($$event);
  },
  $isFunction: true
};

$$.Board_created_autogenerated_anon1 = {"": "Closure;this_3",
  call$0: function() {
    return this.this_3.get$begun();
  },
  $isFunction: true
};

$$.Board_created_autogenerated_anon2 = {"": "Closure;this_4",
  call$1: function(__t) {
    var __xBoard, t1, t2, __e10, __binding9;
    __xBoard = $._ElementFactoryProvider_createElement_html("<div id=\"x-board\" class=\"span6\">\n          <h3>Current board</h3>\n          <button class=\"btn pull-right\" id=\"__e-8\">Next turn</button>\n          <p><strong id=\"__e-10\"></strong>.\n          <template id=\"__e-13\" style=\"display:none\"></template></p>\n          <content></content>\n        </div>");
    t1 = __xBoard.query$1("#__e-8").get$onClick();
    t2 = this.this_4;
    __t.listen$2(t1, new $.Board_created_autogenerated__anon(t2));
    __e10 = __xBoard.query$1("#__e-10");
    __binding9 = __t.contentBind$1(new $.Board_created_autogenerated__anon0(t2));
    $.addAll(__e10.get$nodes(), [document.createTextNode("turn "), __binding9]);
    __t.conditional$3(__xBoard.query$1("#__e-13"), new $.Board_created_autogenerated__anon1(t2), new $.Board_created_autogenerated__anon2(t2));
    $.addAll(__t, [document.createTextNode("\n        "), __xBoard, document.createTextNode("\n      ")]);
  },
  $isFunction: true
};

$$.Board_created_autogenerated__anon = {"": "Closure;this_5",
  call$1: function($$event) {
    this.this_5.nextturn$1($$event);
  },
  $isFunction: true
};

$$.Board_created_autogenerated__anon0 = {"": "Closure;this_6",
  call$0: function() {
    return this.this_6.get$turnCount();
  },
  $isFunction: true
};

$$.Board_created_autogenerated__anon1 = {"": "Closure;this_7",
  call$0: function() {
    return $.$$gt(this.this_7.get$turnCount(), 1);
  },
  $isFunction: true
};

$$.Board_created_autogenerated__anon2 = {"": "Closure;this_8",
  call$1: function(__t) {
    var t1, __binding11, __binding12;
    t1 = this.this_8;
    __binding11 = __t.contentBind$1(new $.Board_created_autogenerated___anon(t1));
    __binding12 = __t.contentBind$1(new $.Board_created_autogenerated___anon0(t1));
    $.addAll(__t, [document.createTextNode("turn "), __binding11, document.createTextNode(" lasted "), __binding12, document.createTextNode(" seconds.")]);
  },
  $isFunction: true
};

$$.Board_created_autogenerated___anon = {"": "Closure;this_9",
  call$0: function() {
    return $.$$sub(this.this_9.get$turnCount(), 1);
  },
  $isFunction: true
};

$$.Board_created_autogenerated___anon0 = {"": "Closure;this_10",
  call$0: function() {
    return this.this_10.get$lastTurnDuration().get$inSeconds();
  },
  $isFunction: true
};
...
$$.Game_created_autogenerated_anon = {"": "Closure;this_0",
  call$1: function($$event) {
    this.this_0.newgame$1($$event);
  },
  $isFunction: true
};

$$.Game_created_autogenerated_anon0 = {"": "Closure;this_1",
  call$0: function() {
    return this.this_1.get$gameCount();
  },
  $isFunction: true
};

$$.Game_created_autogenerated_anon1 = {"": "Closure;this_2",
  call$0: function() {
    return this.this_2.get$gameStartTime();
  },
  $isFunction: true
};
...
$.ReversedListView$ = function(list, start, end) {
  return new $.ReversedListView(list, start, end);
};
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $._FutureImpl$immediate($.CONSTANT10);
  completer = $._CompleterImpl$();
...
$.IterableMixinWorkaround_reversedList = function(l) {
  return $.ReversedListView$(l, 0, null);
};
...
$.List_List$fixedLength$bailout = function(state0, $length, fill, result) {
  var t1, i;
  if ($.$$eq($length, 0) !== true && !(fill == null))
    for (t1 = $.getInterceptor$JSArrayJSString(result), i = 0; $.CONSTANT3.$lt(i, t1.get$length(result)); ++i)
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    if ($._Device_isOpera() !== true && $.contains1($._Device_userAgent(), "MSIE", 0) === true && $.CONSTANT6.containsKey$1(tag) === true)
...
$.Board$forElement = function(e) {
  var t1 = new $.Board(null, null, null, null, false, 0, $.DateTime_DateTime$now(), $.DateTime_DateTime$now(), $.Duration$(0, 0, 0, 0, 0), e, null);
  t1.WebComponent$forElement$1(e);
  return t1;
};

$.Game$forElement = function(e) {
  var t1 = new $.Game(null, null, null, null, null, null, 1, 0, $.DateTime_DateTime$now(), e, null);
  t1.WebComponent$forElement$1(e);
  return t1;
};

$.init_autogenerated = function() {
  var _root, __t, __e1, __e0;
  _root = document.get$body();
  __t = $.Template$(_root);
  __e1 = _root.query$1("#__e-1");
  __e0 = __e1.query$1("#__e-0");
  $.Board$forElement(__e0);
  __t.component$1(__e0);
  $.Game$forElement(__e1);
  __t.component$1(__e1);
  _root.query$1("#stats");
  _root.query$1("#actions");
  __t.create$0();
  __t.insert$0();
};
...
$.CONSTANT7 = new Isolate.$isolateProperties.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT12);
...
$.$defineNativeClass("Node", {"": "$$dom_attributes:attributes~,$$dom_childNodes:childNodes~,$$dom_localName:localName~,$$dom_namespaceUri:namespaceURI~,nextNode:nextSibling~,document:ownerDocument~,parent:parentElement~,parentNode>,text:textContent|",
  get$nodes: function() {
